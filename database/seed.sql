...
\copy users (user_id, signup_date, country, device, acquisition_channel) FROM 'data/raw/users.csv' WITH (FORMAT csv, HEADER true);

\copy accounts (account_id, user_id, plan, account_created_at) FROM 'data/raw/accounts.csv' WITH (FORMAT csv, HEADER true);

\copy subscriptions (subscription_id, account_id, plan, status, started_at, trial_end_at, canceled_at) FROM 'data/raw/subscriptions.csv' WITH (FORMAT csv, HEADER true);

\copy events (event_id, user_id, event_timestamp, event_type, feature, device, country, plan) FROM 'data/raw/events.csv' WITH (FORMAT csv, HEADER true);

\copy sessions (session_id, user_id, started_at, ended_at, device) FROM 'data/raw/sessions.csv' WITH (FORMAT csv, HEADER true);

\copy payments (payment_id, subscription_id, amount, payment_date, status) FROM 'data/raw/payments.csv' WITH (FORMAT csv, HEADER true);
